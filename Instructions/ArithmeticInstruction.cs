...
namespace Untlited_Programming_Game.Instructions
{
    ...
    public class ArithmeticInstruction<T, U> : AssignInstruction<T>
    {
        ...
        public ArithmeticInstruction(Operation operation, T RS1, U RS2, string RD, int line) : base(RS1, RD, line)
        {
